...
export interface SSEEvent {
    type: string;
    data: Record<string, unknown> | unknown[];  // widened: sources arrive as array
...
export const SSE = {
    ...
    /** Citation sources — arrives as raw array */
    sources: (sources?: Array<{ id: string; title: string; article_number: string; chapter?: string; url?: string; score: number }>): SSEEvent => ({
        type: 'sources',
        data: sources ?? [
            { id: 'src-1', title: 'საგადასახადო კოდექსი - მუხლი 309', article_number: '309', chapter: 'VIII თავი', url: 'https://matsne.gov.ge/ka/document/view/1043717?publication=175', score: 0.92 },
            { id: 'src-2', title: 'საგადასახადო კოდექსი - მუხლი 310', article_number: '310', chapter: 'VIII თავი', url: 'https://matsne.gov.ge/ka/document/view/1043717?publication=175', score: 0.85 },
        ],
    }),
};
...
/** Response with citation sources */
export const SOURCES_RESPONSE: SSEEvent[] = [
    SSE.text('საგადასახადო კოდექსის მიხედვით [1], '),
    SSE.text('ასევე მუხლი 310 [2] განსაზღვრავს...'),
    SSE.sources(),
    SSE.done('mock-session-001'),
];
