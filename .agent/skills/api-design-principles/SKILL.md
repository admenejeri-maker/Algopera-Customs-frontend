...
**Invoked by:**
- `/claude-building` — when designing new API contracts or endpoints
- `/opus-planning` — during API architecture phase
- `/deep-research` — when researching REST/GraphQL patterns

**After using this skill:** Route to `/claude-building` to implement the API design.

**Related skills:** `api-security-best-practices`, `auth-implementation-patterns`