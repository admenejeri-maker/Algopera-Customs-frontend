...
**Invoked by:**
- `/opus-planning` — during phase_4_design_check
- Optionally by `/claude-building` — when L/XL task touches core architecture

**After using this skill:** Route review findings back to `/opus-planning`. If design flaws found, loop back to research phase.

**Related skills:** `ai-agents-architect`, `api-design-principles`