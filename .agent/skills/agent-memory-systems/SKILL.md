...
**Invoked by:**
- `/opus-planning` — when planning memory or context management architecture

**After using this skill:** Return architecture decisions back to `/opus-planning`.

**Related skills:** `ai-agents-architect`