...
**Invoked by:**
- `/claude-building` — when writing or modifying API endpoints
- `/deep-research` — when researching security vulnerabilities
- `/debug` — when C3 = authentication broken or unauthorized access

**After using this skill:** Route to `/claude-building` to implement the security fix.

**Related skills:** `api-design-principles`, `auth-implementation-patterns`