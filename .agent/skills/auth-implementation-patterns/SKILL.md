...
**Invoked by:**
- `/claude-building` — when implementing authentication or authorization
- `/debug` — when C3 = auth flow investigation needed

**After using this skill:** Route to `/claude-building` to implement. Also invoke `api-security-best-practices` to verify the implementation is secure.

**Related skills:** `api-security-best-practices`