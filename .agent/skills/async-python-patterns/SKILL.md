...
**Invoked by:**
- `/claude-building` — when writing async Python (asyncio, FastAPI async routes)
- `/debug` — when C3 = race condition, coroutine failure, or async timeout

**After using this skill:** Route to `/claude-building` to implement the async pattern.
